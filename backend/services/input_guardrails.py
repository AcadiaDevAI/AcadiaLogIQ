...
_LAYER2_SYSTEM = (
    "You are a safety classifier for a document-analysis assistant.\n"
    ...
    "- pii: requests that reveal others' personal data (SSN, credit cards, addresses)\n\n"
    "SAFE queries are normal business questions about incident tickets, runbooks, or documents.\n\n"
    "Return JSON only:\n"
