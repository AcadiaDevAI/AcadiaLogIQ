...
import SkeletonCard from "../../../components/Tier1Copilot/SkeletonCard";
...
import EnvironmentContextPanel from "../../../components/Tier1Copilot/journey/EnvironmentContextPanel";
import PreliminaryTier1ChecksHeader from "../../../components/Tier1Copilot/journey/PreliminaryTier1ChecksHeader";
import PreserveEvidenceFooter from "../../../components/Tier1Copilot/journey/PreserveEvidenceFooter";
// US Pharma edit — Stage 0 is the LOCAL cloned copy (KB SOP shortcut).
import Stage0BestTicketDistillation from "./Stage0BestTicketDistillation";
import PivotInsightsPanel from "../../../components/Tier1Copilot/journey/PivotInsightsPanel";
import Stage2HistoricalMatches from "../../../components/Tier1Copilot/journey/Stage2HistoricalMatches";
// US Pharma edit — Stage 3 (Guided Troubleshooting) is intentionally
// removed from this journey; its import is dropped so the bundle does
// not pull in the unused panel.
import Stage4SearchKBHandoff from "../../../components/Tier1Copilot/journey/Stage4SearchKBHandoff";
import Stage5EscalationPackage from "../../../components/Tier1Copilot/journey/Stage5EscalationPackage";
...
import {
  ...
  getResumeState,
  postJourneyEvent,
} from "../../../components/Tier1Copilot/journey/journeyApi";
    ...
    <div className="flex-1 overflow-y-auto py-6 t-bg-primary" style={{ paddingLeft: 8, paddingRight: 8 }}>
      ...
      <div className="w-full mx-auto" style={{ maxWidth: "100%" }}>
        ...
        */}
        ...
        {/* Stage 3 (Guided Troubleshooting) intentionally removed for US Pharma */}
